...
const TRANSITION_ROLES = {
    ...
    [REFERRAL_STATES.APPOINTMENT_BOOKED]: ['PATIENT', 'CAREGIVER', 'HEALTH_WORKER', 'FACILITY_STAFF', 'DOCTOR', 'ADMIN'],
    ...
    [REFERRAL_STATES.TREATMENT_COMPLETED]: ['DOCTOR', 'FACILITY_STAFF', 'ADMIN'],
    [REFERRAL_STATES.FOLLOW_UP_PENDING]: ['DOCTOR', 'FACILITY_STAFF', 'ADMIN'],
