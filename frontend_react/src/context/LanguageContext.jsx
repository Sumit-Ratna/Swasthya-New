...
export const translations = {
    en: {
        ...
        // Circled Header & Home Widget Translations
        ayushmanHeader: 'AYUSHMAN BHARAT SWASTHYA',
        citizenTitle: 'Swasthya Citizen',
        referralInProgress: 'Referral In Progress',
        tokenLabel: 'Token',
        ...
        fastTrackTokenActive: 'Fast-Track OPD Entry Token Active',
        facilityHelpdesk: 'Facility Helpdesk',
        callHelpdesk: 'Call Helpdesk',
        trackJourneyTimeline: 'Track Journey Timeline',
        stageLabel: 'Stage',
        stageBooked: '3. Booked (Active)',
        clickForRouteDetails: 'Click to view route & details',
        platformCapabilities: 'Swasthya Platform Capabilities',
        all6Modules: 'All 6 Core Modules',
        closedLoopBadge: 'Closed-Loop',
        liveBedsBadge: 'Live Beds',
        triageAiBadge: 'Triage AI',
        medgemmaAiBadge: 'MedGemma AI',
        familyProxyBadge: 'Family Proxy',
        ehrRecordsBadge: 'EHR Records',
        openModule: 'Open Module',
        careTeamTitle: 'Your Care Team & Doctors',
        viewAll: 'View All',
        medHistoryDesc: 'Past records, confirmed appointments & health archives',
        feedbackPrompt: 'Feedback',
        detailsBtn: 'Details',
        lessBtn: 'Less',
        specialtyCardiology: 'Cardiology',
        specialtyObstetrics: 'Obstetrics & Gynaecology',
        hospitalNashik: 'District Hospital Nashik',
        hospitalPune: 'Civil Hospital Pune'
    },
    hi: {
        // App Core & Branding
        ...
        // Circled Header & Home Widget Translations
        ayushmanHeader: 'आयुष्मान भारत स्वास्थ्य',
        citizenTitle: 'स्वास्थ्य नागरिक',
        referralInProgress: 'रेफरल जारी है',
        tokenLabel: 'टोकन',
        directionDistance: 'दिशा एवं दूरी',
        routeLabel: 'मार्ग',
        getDirections: 'दिशा-निर्देश पाएं (Google Maps)',
        facilityLocation: 'स्वास्थ्य केंद्र पता',
        assignedConsultant: 'आवंटित डॉक्टर',
        appointmentSchedule: 'अपॉइंटमेंट समय',
        fastTrackTokenActive: 'फास्ट-ट्रैक ओपीडी टोकन सक्रिय',
        facilityHelpdesk: 'अस्पताल हेल्पडेस्क',
        callHelpdesk: 'हेल्पडेस्क पर कॉल करें',
        trackJourneyTimeline: 'पूरी यात्रा टाइमलाइन ट्रैक करें',
        stageLabel: 'चरण',
        stageBooked: '3. स्लॉट बुक (सक्रिय)',
        clickForRouteDetails: 'मार्ग एवं विवरण देखने के लिए क्लिक करें',
        platformCapabilities: 'स्वास्थ्य सेतु मुख्य सेवाएं',
        all6Modules: 'सभी 6 मुख्य मॉड्यूल',
        closedLoopBadge: 'क्लोज्ड-लूप',
        liveBedsBadge: 'लाइव बेड्स',
        triageAiBadge: 'ट्राइएज एआई',
        medgemmaAiBadge: 'मेडजेम्मा एआई',
        familyProxyBadge: 'पारिवारिक प्रॉक्सी',
        ehrRecordsBadge: 'ईएचआर रिकॉर्ड्स',
        openModule: 'मॉड्यूल खोलें',
        careTeamTitle: 'आपके डॉक्टर एवं केयर टीम',
        viewAll: 'सभी देखें',
        medHistoryDesc: 'पुराने रिकॉर्ड, पुष्टि किए गए अपॉइंटमेंट और स्वास्थ्य संग्रह',
        feedbackPrompt: 'प्रतिक्रिया',
        detailsBtn: 'विवरण देखें',
        lessBtn: 'संक्षिप्त करें',
        specialtyCardiology: 'हृदय रोग विशेषज्ञ (Cardiology)',
        specialtyObstetrics: 'स्त्री व प्रसूति रोग विशेषज्ञ (Gynecology)',
        hospitalNashik: 'जिला अस्पताल नासिक',
        hospitalPune: 'सिविल अस्पताल पुणे'
    },
    mr: {
        ...
        ayushmanHeader: 'आयुष्मान भारत स्वास्थ्य',
        citizenTitle: 'स्वास्थ्य नागरिक',
        referralInProgress: 'रेफरल प्रगतीपथावर आहे',
        tokenLabel: 'टोकन',
        directionDistance: 'दिशा आणि अंतर',
        routeLabel: 'मार्ग',
        getDirections: 'दिशा मिळवा (Google Maps)',
        facilityLocation: 'केंद्राचा पत्ता',
        assignedConsultant: 'नियुक्त डॉक्टर',
        appointmentSchedule: 'अपॉइंटमेंट वेळ',
        fastTrackTokenActive: 'फास्ट-ट्रॅक ओपीडी टोकन सक्रिय',
        facilityHelpdesk: 'रुग्णालय मदत केंद्र',
        callHelpdesk: 'मदत केंद्रावर कॉल करा',
        trackJourneyTimeline: 'संपूर्ण टाइमलाइन ट्रॅक करा',
        stageLabel: 'टप्पा',
        stageBooked: '3. स्लॉट बुक (सक्रिय)',
        clickForRouteDetails: 'मार्ग आणि तपशील पाहण्यासाठी क्लिक करा',
        platformCapabilities: 'स्वास्थ्य सेतू मुख्य सेवा',
        all6Modules: 'सर्व 6 मुख्य मॉड्यूल',
        closedLoopBadge: 'क्लोज्ड-लूप',
        liveBedsBadge: 'थेट बेड्स',
        triageAiBadge: 'ट्रायएज एआय',
        medgemmaAiBadge: 'मेडजेम्मा एआय',
        familyProxyBadge: 'कुटुंब प्रॉक्सी',
        ehrRecordsBadge: 'ईएचआर नोंदी',
        openModule: 'मॉड्यूल उघडा',
        careTeamTitle: 'आपले डॉक्टर आणि काळजी पथक',
        viewAll: 'सर्व पहा',
        medHistoryDesc: 'मागील नोंदी, निश्चित अपॉइंटमेंट आणि आरोग्य संग्रह',
        feedbackPrompt: 'अभिप्राय',
        detailsBtn: 'तपशील',
        lessBtn: 'कमी करा',
        specialtyCardiology: 'हृदयरोग तज्ज्ञ',
        specialtyObstetrics: 'स्त्रीरोग व प्रसूती तज्ज्ञ',
        hospitalNashik: 'जिल्हा रुग्णालय नाशिक',
        hospitalPune: 'सिव्हिल रुग्णालय पुणे'
    }
};
