...
const Profile = () => {
    ...
    const syncUserData = (u) => {
        ...
        setFormData({
            ...
            address_city: u.address_city || medHist.address_city || 'Greater Noida',
            address_state: u.address_state || medHist.address_state || 'Uttar Pradesh',
            pincode: u.pincode || medHist.pincode || '203201',
            address: u.address || medHist.address || 'Near Galgotias University, Yamuna Expressway, Dankaur',
            ...
            emergency_contact: u.emergency_contact || medHist.emergency_contact || '+91 9811200108',
            emergency_contact_name: medHist.emergency_contact_name || 'Family Contact',
            emergency_relation: medHist.emergency_relation || 'Parent / Guardian',
            specialization: u.specialization || 'Cardiology & General Medicine',
            hospital_name: u.hospital_name || 'Primary Health Centre (PHC) Dankaur / GIMS',
            doctor_qr_id: u.doctor_qr_id || 'DOC-UP-4021',
            mci_registration: 'MCI-2018-84920-UP',
            opd_timings: '09:00 AM - 02:00 PM (Mon-Sat)',
            asha_id: 'ASHA-UP-GBN-084',
            village_catchment: 'Dankaur & Kasna Sector 17-A',
            assigned_phc: 'Primary Health Centre (PHC) Dankaur',
            dbt_account_last4: '4821 (State Bank of India)',
            facility_id: 'FAC-UP-GBN-001',
            facility_tier: 'DISTRICT_HOSPITAL (24x7 Emergency Capable)',
            bed_capacity: '250 General / 40 ICU / 60 O2 / 30 Maternity',
            nodal_officer: 'Dr. Suresh Verma (Medical Superintendent)',
            caregiver_id: 'CG-ABDM-8921',
            dependent_count: '2 Family Members Linked',
            proxy_relationship: 'Primary Family Proxy & Legal Caregiver',
            officer_id: 'NHA-ADM-UP-01',
            jurisdiction: 'Uttar Pradesh State / Gautam Buddha Nagar Cluster',
